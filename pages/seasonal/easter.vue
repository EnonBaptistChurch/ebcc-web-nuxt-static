...
import services from '../../data/EasterServices'
...
.bg-texture {
  ...
  inset: 0;
  background-image:
    radial-gradient(ellipse 80% 60% at 50% 0%, rgba(212, 175, 100, 0.12) 0%, transparent 70%),
    radial-gradient(ellipse 60% 50% at 80% 100%, rgba(180, 140, 80, 0.08) 0%, transparent 60%);
  pointer-events: none;
}
...
.service-inner {
  ...
  box-shadow: 0 2px 16px rgba(100, 70, 20, 0.06), inset 0 1px 0 rgba(255,255,255,0.8);
}
...
.service-inner:hover {
  ...
  box-shadow: 0 6px 28px rgba(100, 70, 20, 0.1), inset 0 1px 0 rgba(255,255,255,0.9);
