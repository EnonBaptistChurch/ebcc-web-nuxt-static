<template>
    <div>
        ...
        <p class="subtitle">
            We have links with missionaries and mission organisations serving across the world, taking the gospel to the nations.
        </p>
        </header>
...
useHead({
  title: 'Links - Missionary Links - Enon Baptist Church',
  meta: [
    {
      name: 'description',
      content: 'Explore the missionaries and missionary organisation links at Enon Baptist Church, Chatham. '
    }
  ]
})
</script>
