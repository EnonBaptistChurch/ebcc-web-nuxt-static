...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Summary of the essential doctrines which we at Enon Baptist Church believe.' },
    { name: 'keywords', content: 'Bible, Doctrine, Church, Christianity, NKJV' }
  ]
})
