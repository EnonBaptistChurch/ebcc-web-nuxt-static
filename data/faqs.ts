...
export const faqs: FAQ[] = [
  ...
  { id: 2, category: 'Service Times & Location', question: 'Where is the church located?', answer: 'We are located Skinner Street, Chatham, ME4 5RF. Full directions and parking info are on our Find Us page.', keywords: ['location', 'address', 'directions'] },
  { id: 3, category: 'Service Times & Location', question: 'Is there parking available?', answer: 'Yes — we have a car park though this can be quite full for the morning service. If it is your first time we would advise arriving early. When the car park is full there is some on-street parking nearby, which should allow enough time to go to the service.', keywords: ['parking', 'lot', 'drive'] },
  ...
  { id: 6, category: 'Visiting', question: 'What can I expect when I visit?', answer: 'You will get a warm welcome, reverent worship, practical teaching, and a friendly community.', keywords: ['new here', 'first time', 'visit'] },
  { id: 7, category: 'Visiting', question: 'What should I wear?', answer: 'We have a range of clothing attire at our Sunday services. Whether you prefer smart or casual, you’re welcome to come as you are.', keywords: ['dress', 'attire', 'clothing'] },
  { id: 9, category: 'Visiting', question: 'Is there a welcome team?', answer: 'Yes — our welcome team is available before and after services to answer questions and help you with anything related to Enon Baptist Church Chatham. If they don\'t know they will know who to direct you towards.', keywords: ['welcome', 'greet', 'usher'] },
